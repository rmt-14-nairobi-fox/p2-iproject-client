<template>
  <div class="container">
    <div class="tengahin">
      <div class="">
        <form action="#" id="login-form" class="box" @submit.prevent="loginBtn">
          <h1>Login</h1>
          ...
          <a class="forgot text-muted" href="#" @click="toRegister">Register a new account</a>
          <div class="col-md-12">
            <ul class="social-network social-circle">
              <a style="color: aliceblue">sign in with Google</a>
              <li>
                <a
                  href="#"
                  class="icoGoogle g-signin2 bi bi-google"
                  title="Google"
                >
                  <i class="bi bi-google">G</i></a
                >
              </li>
            </ul>
          </div>
...
export default {
  ...
  computed: {
    ...mapState(["currentRole", "isLoggedIn"]),
  },
};
</script>
