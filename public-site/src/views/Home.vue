<template>
  <div class="w-full overflow-x-hidden border-t flex flex-col">
    <main class="w-full flex-grow p-6">
      <h1 class="text-3xl text-black pb-6 mx-80">All Accommodations</h1>
      <div class="relative text-gray-600 lg:block hidden mx-80">
        <input
          class="
...
export default {
  ...
  computed: {
    accommodations() {
      if (this.textSearch) {
        return this.$store.state.accommodations.filter((el) => {
